...
#     highlights:
#       - title: Download<code>go </code> to create a new project .
  ...
  - header: Add things you want in markdown
    ...
    bgImageDark: https://theme-hope-assets.vuejs.press/bg/10-light.svg
    bgImageStyle:
...
copyright: false
footer: Theme by <a href="https://theme-hope.vuejs.press/" target="_blank">Hope</a> | MIT Licensed, Copyright © 2024-present Mr.Cillian
---