...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这个例子中，我们启动了两个goroutine来模拟两个服务器的响应。<code>select</code> 语句用于等待这两个通道中的第一个响应，并打印它。</p><p>控制结构是Go编程中的基础。通过这些示例和解释，你应该能更好地理解它们的用法并在你自己的代码中灵活运用它们。记住，实践是最好的老师，所以不断地尝试和练习将帮助你深化这些概念。</p>`,28),o=[p];function i(c,l){return s(),a("div",null,o)}const d=n(t,[["render",i],["__file","5-controlstructure.html.vue"]]),k=JSON.parse('{"path":"/zh/basic/5-controlstructure.html","title":"5.控制结构","lang":"zh-CN","frontmatter":{"title":"5.控制结构","order":5,"category":["数据"],"tag":["布局"],"description":"Go语言中控制结构的掌握：带例子的指南 在编程中，使用各种控制结构来指导执行流程。Go语言提供了一套丰富的控制结构，使得代码的逻辑控制既简洁又高效。在本文中，我们将详细介绍Go语言的几种控制结构，并通过示例和注释来加深理解。 if语句 if 是最基本的控制结构，它允许基于布尔条件来执行代码。Go语言中的 if 语句不需要圆括号包围条件，但是花括号是必须...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/zh/basic/5-controlstructure.html"}],["meta",{"property":"og:site_name","content":"Go-Cillian"}],["meta",{"property":"og:title","content":"5.控制结构"}],["meta",{"property":"og:description","content":"Go语言中控制结构的掌握：带例子的指南 在编程中，使用各种控制结构来指导执行流程。Go语言提供了一套丰富的控制结构，使得代码的逻辑控制既简洁又高效。在本文中，我们将详细介绍Go语言的几种控制结构，并通过示例和注释来加深理解。 if语句 if 是最基本的控制结构，它允许基于布尔条件来执行代码。Go语言中的 if 语句不需要圆括号包围条件，但是花括号是必须..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-04-12T13:33:09.000Z"}],["meta",{"property":"article:author","content":"Cillian"}],["meta",{"property":"article:tag","content":"布局"}],["meta",{"property":"article:modified_time","content":"2024-04-12T13:33:09.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"5.控制结构\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-04-12T13:33:09.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Cillian\\",\\"url\\":\\"https://www.cillian.website\\"}]}"]]},"headers":[{"level":2,"title":"if语句","slug":"if语句","link":"#if语句","children":[]},{"level":2,"title":"for循环","slug":"for循环","link":"#for循环","children":[{"level":3,"title":"基本的for循环","slug":"基本的for循环","link":"#基本的for循环","children":[]},{"level":3,"title":"while风格的for循环","slug":"while风格的for循环","link":"#while风格的for循环","children":[]},{"level":3,"title":"无限循环","slug":"无限循环","link":"#无限循环","children":[]}]},{"level":2,"title":"switch语句","slug":"switch语句","link":"#switch语句","children":[]},{"level":2,"title":"select语句","slug":"select语句","link":"#select语句","children":[]}],"git":{"createdTime":1712928789000,"updatedTime":1712928789000,"contributors":[{"name":"cilliandevops","email":"cilliandevops@gmail.com","commits":1}]},"readingTime":{"minutes":3.07,"words":922},"filePathRelative":"zh/basic/5-controlstructure.md","localizedDate":"2024年4月12日","autoDesc":true}');export{d as comp,k as data};
